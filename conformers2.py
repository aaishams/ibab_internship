    ...
    if property == 1: #bond length
        ...
        if property2 == 1: #compare bond length
            ...
            if atom1 > len(coordinates) or atom2 > len(coordinates) or atom1 > len(coordinates2) or atom2 > len(coordinates2) or len(set([atom1, atom2])) !=2:
                ...
                print(f"The bond length between {coordinates[atom1 - 1][0]}[{atom1}] and {coordinates[atom2 - 1][0]}[{atom2}] of conformer 1 is {bl:.5f} Å.")
                print(f"The bond length between {coordinates2[atom1 - 1][0]}[{atom1}] and {coordinates2[atom2 - 1][0]}[{atom2}] of conformer 2 is {bl2:.5f} Å.")
                print(f"Difference in bond length between the two conformers = {abs(bl - bl2):.5f} Å")
            else:
            ...
            if atom1 > len(coordinates) or atom2 > len(coordinates) or atom3 > len(coordinates) or atom1 > len(coordinates2) or atom2 > len(coordinates2) or atom3 > len(coordinates2) or len(set([atom1, atom2, atom3])) != 3:
                ...
                print(f"The bond angle formed by {coordinates[atom1 - 1][0]}[{atom1}], {coordinates[atom2 - 1][0]}[{atom2}] and {coordinates[atom3 - 1][0]}[{atom3}] of conformer 1 is {ba:.5f}°.")
                print(f"The bond angle formed by {coordinates2[atom1 - 1][0]}[{atom1}], {coordinates2[atom2 - 1][0]}[{atom2}] and {coordinates2[atom3 - 1][0]}[{atom3}] of conformer 2 is {ba2:.5f}°.")
                print(f"Difference in bond angle between the two conformers = {abs(ba - ba2):.5f}°")
            else:
            ...
            if atom1 > len(coordinates) or atom2 > len(coordinates) or atom3 > len(coordinates) or atom4 > len(coordinates) or atom1 > len(coordinates2) or atom2 > len(coordinates) or atom3 > len(coordinates) or atom4 > len(coordinates2) or len(set([atom1, atom2, atom3, atom4])) !=4:
                ...
                print(f"The dihedral angle formed by {coordinates[atom1 - 1][0]}[{atom1}], {coordinates[atom2 - 1][0]}[{atom2}], {coordinates[atom3 - 1][0]}[{atom3}] and {coordinates[atom4 - 1][0]}[{atom4}] of conformer 1 is {da:.5f}°.")
                print(f"The dihedral angle formed by {coordinates2[atom1 - 1][0]}[{atom1}], {coordinates2[atom2 - 1][0]}[{atom2}], {coordinates2[atom3 - 1][0]}[{atom3}] and {coordinates2[atom4 - 1][0]}[{atom4}] of conformer 2 is {da2:.5f}°.")
                print(f"Difference in dihedral angle between the two conformers = {abs(da - da2):.5f}°")
        else:
